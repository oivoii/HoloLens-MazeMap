...
public class BuildMesh3 : MonoBehaviour {
    ...
    void Start () {
        ...
        for (int i = 0; i < vectorLength; i++)
        {
            ...
            vertices[i][2] = (float)(1000 * (y - refY));
            vertices[i][1] = (float)(1000 * (z - refZ));
        ...
        for (int i = 1; i < vectorLength; i++)
        {
            ...
            vertices[i + vectorLength][1] = 1000 * roomHeight;
        }
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            vertices[i].x = (int)(1000 * (vertices[i].x - centerX));
            
            vertices[i].y = (int)(1000 * (vertices[i].y - centerY));
            
            vertices[i].z = (int)(1000 * (vertices[i].z - centerZ));
        }
        ...
        for (int i = 0; i < vertices.Length; i++)
        {
            ...
            vertices[i][1] = (((vertices[i][1]) / 1000000) * scaleFactor);
