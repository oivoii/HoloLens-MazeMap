...
public class BuildMesh2 : MonoBehaviour {
    ...
    void Start () {
        ...
        {
            if (inputVector[roomIndex].Count < inputVector[i].Count)
            {
                roomIndex = i;
            }
        }
        ...
        int vectorLength = inputVector[roomIndex].Count - 1;
